...
|--------|-------------|-------|
| [**LLM Conversational Agent**](https://github.com/realAkshaj/Conversational-AI-RAG-Chatbot) | AI agent with function calling, Redis memory, PostgreSQL history. 75% task success rate, 200+ conversations/day | Python, LangChain, OpenAI, AWS Lambda |
